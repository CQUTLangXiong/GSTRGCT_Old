...
root_data_path = 'F:/广义时空回归图卷积神经网络/GSTRGCT/data'
fig_path = 'F:/广义时空回归图卷积神经网络/GSTRGCT/fig'
...
def load_data(data_file_name):
    ...
    return data, np.array(scale_data)
...
def scaled_Laplacian(W):
    ...
    return (2 * L) / lambda_max - np.identity(W.shape[0]) # 波浪符号的L
...
if __name__ == "__main__":
    A, A_distance, dist_mean, dist_std=get_adjacency_matrix('F:\广义时空回归图卷积神经网络\GSTRGCT\data\PEMS04\distance.csv', 307)
    # print(A.shape, distanceA.shape)
    data, scale_data= load_data('F:/广义时空回归图卷积神经网络/GSTRGCT/data/pems08/pems08.npz')
